...
IF (ORACLE_USE_CLNTST)
  ...
  FIND_LIBRARY(ORACLE_LIBRARY_LIBIRC        NAMES irc         PATHS ${ORACLE_LIB_LOCATION} NO_DEFAULT_PATH )
  ...
  ENDIF()
  IF(ORACLE_LIBRARY_LIBIRC)
    LIST(APPEND ORACLE_STATIC_LIBRARIES ${ORACLE_LIBRARY_LIBIRC})
  ENDIF()
